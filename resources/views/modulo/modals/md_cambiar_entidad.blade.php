    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            <h4 class="modal-title">
                <i class="las la-random me-1"></i> Cambio de Entidad
            </h4>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-9">
                        <input type="date" class="form-control"
                            value="{{ $modulo->FECHAINICIO ? \Carbon\Carbon::parse($modulo->FECHAINICIO)->format('Y-m-d') : '' }}"
                            readonly>
                    </div>
                </div>

                <!-- Fecha fin de la entidad actual -->
                <div class="row mb-3">
                    <label class="col-3 col-form-label">Entidad actual termina el</label>
                    <div class="col-9">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-outline-success" id="btnConfirmarCambio"
                onclick="btnGuardarCambioEntidad('{{ $modulo->IDMODULO }}')">
                Confirmar Cambio
            </button>
        </div>
    </div>
