...
<div class="card">
    ...
    <div class="card-body">
        <div class="mb-3 d-flex gap-2 flex-wrap">
            ...
            <a href="{{ route('modulos.monitoreo') }}" class="btn btn-info text-white">
                <i class="fa fa-calendar-check"></i> Monitoreo Módulos Activos
            </a>
        </div>
...
<script>
    ...
    function cargarModulos(mac = '', entidad = '', admin = '') {
        $.ajax({
            ...
            beforeSend: function() {
                if ($.fn.DataTable.isDataTable('#table_modulos')) {
                    $('#table_modulos').DataTable().clear().destroy();
                }
