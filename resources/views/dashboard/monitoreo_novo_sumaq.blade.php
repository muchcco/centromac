...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row">
                <div class="col">
                    <h4 class="page-title">Reportes - Ticket sumaq</h4>
                    <ol class="breadcrumb">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="media">
                ...
                <div class="media-body align-self-center">
                    ...
                    <span>Si el dashboard no se visualiza, <a
                            href="https://app.powerbi.com/view?r=eyJrIjoiNjAzZDIwMGYtZjlhNi00ZDk1LTgzN2UtODQ0OWE4YzVlNjQzIiwidCI6IjM0YjQ4ZTRlLTI1MTktNDA2MC1hMDllLTViMDVkOTAxYTRkNyJ9"
            ...
            <div class="card-body">
                <iframe src="https://app.powerbi.com/view?r=eyJrIjoiNjAzZDIwMGYtZjlhNi00ZDk1LTgzN2UtODQ0OWE4YzVlNjQzIiwidCI6IjM0YjQ4ZTRlLTI1MTktNDA2MC1hMDllLTViMDVkOTAxYTRkNyJ9" frameborder="0" class="power-bi-dash"></iframe>
            </div>
        </div>
    </div>
</div>
