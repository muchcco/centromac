        ...
        <div class="modal-body">
            ...
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" id="descripcion" placeholder="Descripción del bien" value="{{ $almacen->DESCRIPCION }}">
                </div>
                <div class="form-group col-md-3">
                    ...
                    <select name="idmarca" id="idmarca" class="form-select">
                        ...
                        @foreach ($marca as $c)
                            <option 
                                value="{{ $c->IDMARCA }}" 
                                @if (isset($almacen))
                                  {{ $c->IDMARCA == $almacen->IDMODELO ? 'selected' : '' }}    
                                @endif>
                                    {{ $c->NOMBRE_MARCA }}
                            </option>
                        @endforeach                        
                ...
                <div class="form-group col-md-3">
                    ...
                    <select name="idmodelo" id="idmodelo" class="form-select">
                        @if (isset($almacen))
                            <option value="{{ $almacen->IDMODELO }}"  selected>{{ $almacen->NOMBRE_MODELO }}</option>
                        @else
                            <option value="0" disabled selected>-- SELECCIONE UNA OPCION --</option>
                        @endif
                    </select>
