            ...
            <li class="list_empl">
                <div class="text-simpl">
                    <span class="text-list-ent col-7">
                        <div style="display:flex; justify-content: start; align-self: center; width:100%;">{{ $entidad->ABREV_ENTIDAD }}</div> 
                    ...
                    <span class="col-2" style="display:flex; justify-content: center; align-self: center;">
                        <a href="{{ route('mobile.det_entidad', [$mac->IDCENTRO_MAC, $entidad->IDENTIDAD]) }}" class="nobtn" >
