<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">Editar centro MAC - {{ $mac->NOMBRE_MAC }}</h4>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="centro_mac" disabled onkeyup="isMayus(this)" value="{{ $mac->NOMBRE_MAC }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="fecha_apertura" required="" value="{{ $mac->FECHA_APERTURA }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label" for="fecha_inaguracion">Fecha de inaguración</label>
                            <input type="date" class="form-control" id="fecha_inaguracion" required="" value="{{ $mac->FECHA_INAGURACION }}">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="departamento" id="departamento" class="form-select">
                                ...
                                @foreach ($departamento as $dep)
                                    <option value="{{$dep->IDDEPARTAMENTO}}" {{ $mac->IDDEPARTAMENTO == $dep->IDDEPARTAMENTO ? 'selected' : '' }} > {{$dep->NAME_DEPARTAMENTO}} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="provincia" id="provincia" class="form-select">
                                ...
                                @foreach ($provincia as $prov)
                                    <option value="{{$prov->IDPROVINCIA}}" {{ $mac->IDPROVINCIA == $prov->IDPROVINCIA ? 'selected' : '' }} > {{$prov->NAME_PROVINCIA}} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="distrito" id="distrito" class="form-select">
                                ...
                                @foreach ($distrito as $dist)
                                    <option value="{{$dist->IDDISTRITO}}" {{ $mac->IDDISTRITO == $dist->IDDISTRITO ? 'selected' : '' }} > {{$dist->NAME_DISTRITO}} </option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="ubicacion" required onkeyup="isMayus(this)" value="{{ $mac->DIRECCION_MAC }}">
                        </div>
                    </div>
                </div>
            </form>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-outline-success" id="btnEnviarForm" onclick="btnUpdateMac('{{ $mac->IDCENTRO_MAC }}')">Actualizar</button>
        </div>
    </div>
</div>
