                ...
                <div class="row">
                    <div class="col">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0);" style="color: #7081b9;">Hoy
                                    <strong>(<?php setlocale(LC_TIME, 'es_PE', 'Spanish_Spain', 'Spanish');
                                    echo strftime('%d de %B del %Y', strtotime('now')); ?>)</strong></a></li>
                        </ol>
                    </div><!--end col-->
                </div><!--end row-->
