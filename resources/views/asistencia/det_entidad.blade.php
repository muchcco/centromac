                    ...
                    <div class="row">
                                ...
                                <select name="mac" id="mac" class="form-select" onchange="SearchMac()">
                                    @role('Administrador|Moderador')
                                        <option value="" disabled
                                            {{ old('mac', request('mac')) === null ? 'selected' : '' }}>-- Seleccione una opción
                                            --</option>
                                        <option value="0" {{ old('mac', request('mac')) == 0 ? 'selected' : '' }}>Todos
                                        </option>
                                        @forelse ($mac as $m)
                                            <option value="{{ $m->IDCENTRO_MAC }}"
                                                {{ old('mac', request('mac')) == $m->IDCENTRO_MAC ? 'selected' : '' }}>
                                                {{ $m->NOMBRE_MAC }}
                                            </option>
                                        @empty
                                    ...
                                    @else
                                        @forelse ($mac as $m)
                                            <option value="{{ $m->IDCENTRO_MAC }}" selected disabled>
                                                {{ $m->NOMBRE_MAC }}
                                            </option>
                                        @empty
                                            <option value="">SIN RESULTADOS</option>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="año" id="año" class="form-select select2 año"
            ...
            <div class="card">
                ...
                <div class="card-body bootstrap-select-1">
                    <div class="alert custom-alert custom-alert-warning icon-custom-alert shadow-sm fade show d-flex justify-content-between"
                        ...
                        <div class="media">
                            <i
                                class="la la-exclamation-triangle alert-icon text-warning align-self-center font-30 me-3"></i>
                            <div class="media-body align-self-center">
                                <h5 class="mb-1 fw-bold mt-0">Importante</h5>
                                <span>Si una entidad no se visualiza, es porque el usuario no ha culminado de realizar su
                                    registro.</span>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            <a class="btn btn-danger" href="{{ url()->previous() }}"><i class="fa fa-arrow-left"
