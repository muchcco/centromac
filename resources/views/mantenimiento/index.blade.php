...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row">
                <div class="col">
                    <h4 class="page-title">Módulo de Mantenimientos programados</h4>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);" style="color: #7081b9;">Mantenimientos</a></li>
                    </ol>
                </div><!--end col--> 
            </div><!--end row--> 
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header" style="background-color:#132842">
                <h4 class="card-title text-white">CONSOLIDADO DE MANTENIMIENTOS DEL CENTRO MAC -  
                    @php
            ...
            <div class="card-body bootstrap-select-1">
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <button class="btn btn-success" data-toggle="modal" data-target="#large-Modal" onclick=""><i class="fa fa-plus" aria-hidden="true"></i>
                            Agregar bien</button>
                    </div>
                </div>
                <div class="row">
