...
@section('script')
    ...
    <script>
        function execute_filter() {
            ...
            if (!mes || !año) {
                alert("Por favor, seleccione todos los campos obligatorios: Mes y Año.");
                return;
            }
            ...
            $.ajax({
                type: 'GET',
                url: "{{ route('reporte.ocupabilidad.tablas.tb_index') }}",
                data: {
                    mes: mes,
                    año: año
                },
        ...
        function exec_data_excel() {
            ...
            // Redirigir a la ruta de exportación a Excel
            window.location.href = "{{ route('reporte.ocupabilidad.export_excel') }}?mes=" + mes + "&año=" + año;
        }
    </script>
@endsection
