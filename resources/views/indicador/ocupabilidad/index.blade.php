...
<div class="row">
    <div class="col-sm-12">
        <div class="page-title-box">
            <div class="row">
                <div class="col">
                    <h4 class="page-title">Ocupabilidad</h4>
                    <ol class="breadcrumb">
                    ...
                    <div class="col-md-5 border-end">
                        <table class="table table-bordered ">
                            ...
                            <tr>
                                ...
                                <td>Módulo con presencia de asesor(a) de servicio de la entidad participante</td>
                            </tr>
                            <tr>
                                <th class="text-center" style="background: #2F75B5">NO</th>
                                <td>Módulo que estuvo sin presencia de asesor(a) de servicio, durante un día de operación del Centro MAC</td>
                            </tr>
...
<section>
    <div class="row" id="table_evalua">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header" style="background-color:#132842">
                    <h4 class="card-title text-white">INDICADOR DE OCUPABILIDAD CENTRO MAC -  
                        @php
...
function tabla_seccion(mes = '', año = '') {
    $.ajax({
        type: 'GET',
        url: "{{ route('indicador.ocupabilidad.tablas.tb_index') }}", // Ruta que devuelve la vista en HTML
...
function exec_data_excel(){
    ...
    var link_up = "{{ route('indicador.ocupabilidad.export_excel') }}";
