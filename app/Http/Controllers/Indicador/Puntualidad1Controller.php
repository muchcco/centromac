...
class Puntualidad1Controller extends Controller
{
    ...
    public function tb_index(Request $request)
    {
        ...
        return view('indicador.puntualidad.tablas.tb_index', compact('name_mac', 'query', 'fecha_mes', 'fecha_año', 'nombre_mes', 'daysInMonth', 'feriados'));
    }
    ...
    public function export_excel(Request $request)
    {
        ...
        $export = Excel::download(
            new IndicadorPuntualidadExport($query, $fecha_año, $fecha_mes, $name_mac, $nombre_mes, $daysInMonth, $feriados),
            'INDICADOR_DE_PUNTUALIDAD_' . $name_mac . '_' . $fecha_año . '_' . $nombre_mes . '.xlsx'
        );
