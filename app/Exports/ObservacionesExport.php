...
class ObservacionesExport implements FromView, WithDefaultStyles, ShouldAutoSize, WithDrawings, WithStyles, WithTitle
{
    protected $observaciones;
    protected $nombreMac;
    protected $nombreMes;

    public function __construct($observaciones, $nombreMac, $nombreMes)
    {
    ...
    {
        return view('observacion.exports.excel', [
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $lastRow = count($this->observaciones) + 8; // Por los encabezados, empieza en fila 9 aprox.
    ...
    {
        return 'Observaciones ' . $this->nombreMac;
    }
}
